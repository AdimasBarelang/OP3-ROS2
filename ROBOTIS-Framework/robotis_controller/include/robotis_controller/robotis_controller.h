...
/*
 * robotis_controller.hpp
 *
 *  Created on: 2016. 1. 15.
 *      Author: zerom
 */

#ifndef ROBOTIS_CONTROLLER_ROBOTIS_CONTROLLER_HPP_
#define ROBOTIS_CONTROLLER_ROBOTIS_CONTROLLER_HPP_
...
public:
  ...
  /* publisher */
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr  goal_joint_state_pub_;
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr  present_joint_state_pub_;
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr      current_module_pub_;

  std::map<std::string, rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr> gazebo_joint_position_pub_;
  std::map<std::string, rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr> gazebo_joint_velocity_pub_;
  std::map<std::string, rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr> gazebo_joint_effort_pub_;
...
#endif /* ROBOTIS_CONTROLLER_ROBOTIS_CONTROLLER_HPP_ */
